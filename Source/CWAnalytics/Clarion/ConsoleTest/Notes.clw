! *************************************************
! Notes used during presentation to build 
! ConsoleTest from scratch. 
! Notice the properties of _this_ file have 
! a build action set to "none" instead of "compile"
! *************************************************
    PROGRAM
...
TempCS  CStringClass
  ...
  Console.WriteLine('Init Analytics...')
